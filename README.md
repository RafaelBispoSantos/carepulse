<div align="center">
  ...
  <div align="center">
    🛠️ Este projeto foi desenvolvido por mim seguindo as aulas do <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>JavaScript Mastery</b></a><br>
    💡 Um projeto educativo onde pude aprimorar minhas habilidades em Next.js, TypeScript e desenvolvimento full-stack<br>
    🚀 Junte-se à comunidade JSM e acelere seu aprendizado!
  </div>
</div>
...
Um aplicativo de gerenciamento de pacientes de saúde que permite cadastro, agendamento e gestão de consultas médicas, com ferramentas administrativas para agendamento, confirmação e cancelamento de consultas, incluindo notificações por SMS, construído com Next.js.

Se precisar de ajuda ou encontrar bugs, junte-se à nossa comunidade ativa no Discord com mais de **34k+** membros. Um lugar onde todos se ajudam.

<a href="https://discord.com/invite/n6EdbFJ" target="_blank"><img src="https://github.com/sujatagunale/EasyRead/assets/151519281/618f4872-1e10-42da-8213-1d69e486d02e" /></a>

## ⚙️ Tecnologias Utilizadas <a name="tecnologias-utilizadas"></a>

| Frontend         | Backend/Serviços   | Validação/Utilitários       |
|------------------|--------------------|----------------------------|
| Next.js 15       | Appwrite 12        | Zod 3                      |
| React 19         | Node-Appwrite 12   | React Hook Form 7          |
| Tailwind CSS 3   | JWT (Auth)         | Class Variance Authority   |
| Radix UI         | Appwrite Database  | Tailwind Merge             |
| Shadcn/ui        | Appwrite Storage   | Lucide React (Ícones)      |
| React DatePicker | Appwrite Functions | React Phone Number Input   |

**Principais Características:**
- ⚡ Next.js TurboPack para desenvolvimento rápido
- 🛡️ Validação de formulários com Zod + React Hook Form
- 📦 Componentes UI acessíveis com Radix + Shadcn
- 📅 Controles de data/hora com React DatePicker
- ☁️ Backend totalmente gerenciado com Appwrite
- 🎨 Design system com Tailwind CSS + Tailwind Merge
- 🔐 Autenticação JWT integrada
- 📱 Inputs especializados (telefone, upload de arquivos)
...
👉 **Cadastro de Pacientes**: Usuários podem se registrar e criar um perfil pessoal.

👉 **Agendar Consultas**: Pacientes podem marcar consultas com médicos de forma conveniente.

👉 **Gerenciamento Administrativo**: Administradores podem visualizar e gerenciar todas as consultas.

👉 **Confirmação de Consultas**: Admins podem confirmar e definir horários das consultas.

👉 **Cancelamento de Consultas**: Admins podem cancelar consultas quando necessário.

👉 **Notificação por SMS**: Pacientes recebem confirmações via SMS.

👉 **Design Responsivo**: Funciona perfeitamente em todos os dispositivos.

👉 **Upload de Arquivos**: Armazenamento seguro de documentos usando Appwrite Storage.

👉 **Monitoramento com Sentry**: Rastreamento de desempenho e erros usando Sentry.
...
Substitua os valores do espaço reservado pelas suas credenciais reais do Appwrite. Você pode obter essas credenciais inscrevendo-se no [Appwrite website](https://appwrite.io/).
...
Open [http://localhost:3000](http://localhost:3000) no seu navegador para visualizar o projeto.
...
[![Deploy na Vercel](https://vercel.com/button)](https://carepulse-five-xi.vercel.app/)  
